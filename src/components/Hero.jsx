        ...
        <div className="lg:grid lg:grid-cols-12 lg:gap-x-8 lg:gap-y-20">
          <div className="relative z-10 max-w-2xl mx-auto lg:col-span-7 lg:max-w-none lg:pt-6 xl:col-span-6">
            <h1 className="text-4xl font-medium tracking-tight text-gray-900">
              Tu tiempo vale su belleza: Gestiona citas y deslumbra clientas.
            </h1>
            <p className="mt-6 text-lg text-gray-600">
              Nuestra innovadora aplicación web te brinda la solución perfecta para simplificar y optimizar la gestión de turnos en tu estudio de maquillaje. 
            </p>
            <div className="flex flex-wrap mt-8 gap-x-6 gap-y-4">
              {/* <AppStoreLink /> */}
              <Button
                href="https://youtu.be/fYodAU6JdGU"
                variant="outline"
              >
